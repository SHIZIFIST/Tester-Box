...
#define TEST_BUTTON           6   // TEST Button ---ANALOG PIN---
#define ADJUSTMENT_POT        7   // Pot for whatever ---ANALOG PIN---
...
bool testButtonPressedFlag = false;
bool stepButtonPressedFlag = false;
